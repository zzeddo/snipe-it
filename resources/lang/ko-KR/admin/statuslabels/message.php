...
return [
    ...
    'help' => [
        ...
        'deployable'   => '이러한 자산은 반출 할 수 있습니다. 할당되면 <i class="fas fa-circle text-blue"></i> <strong>Deployed</strong>의 메타 상태로 가정합니다.',
        'archived'   => '이러한 자산은 반출할 수 없으며 보관된 보기에만 표시됩니다. 이는 예산/이력 추적 목적을 위해 자산에 대한 정보를 보유하지만 일상적인 자산 목록에서 유지하는 데 유용합니다.',
        'pending'   => '이러한 자산은 아직 수리를 위해 나가는 품목에 자주 사용되지만 누구에게나 할당 될 수는 없지만 반납될 것으로 예상됩니다.',
    ],
