...
return [
    ...
    'importing'         	=> '가져오는 중',
    'importing_help'        => 'CSV 파일을 통해 자산, 자산, 부속품, 라이센스, 구성요소, 소모품, 사용자을 가져올 수 있습니다. <br><br>CSV 파일은 쉼표로 구분되어야 하며, 헤더와 일치해야 합니다. <a href="https://snipe-it.readme.io/docs/importing" target="_new">CSVs 예제입니다.</a>.',
