...
return [
    ...
    'Accessory_Checkout_Notification' => '부속품 체크아웃',
    'Asset_Checkin_Notification' => '자산 반입됨',
    'Asset_Checkout_Notification' => '자사 체크아웃',
    'Confirm_Accessory_Checkin' => '부속품 반입 확인',
    'Confirm_Asset_Checkin' => '자산 반입 확인',
    'Confirm_accessory_delivery' => '부속품 지급 확인',
    'Confirm_asset_delivery' => '자산 지급 확인',
    'Confirm_consumable_delivery' => '소모품 지급 확인',
    'Confirm_license_delivery' => '라이센스 지급 확인',
    'Consumable_checkout_notification' => '소모품 체크아웃',
    'Days' => '일',
    'Expected_Checkin_Date' => '체크아웃된 자산이 :date 에 체크인될 예정입니다.',
    'Expected_Checkin_Notification' => '알림: :name 체크인 마감일이 다가옴',
    'Expected_Checkin_Report' => '예상 자산 체크인 보고서',
    ...
    'License_Checkout_Notification' => '라이센스 체크아웃',
    'Low_Inventory_Report' => '재고 부족 보고서',
    'a_user_canceled' => '사용자가 웹사이트에서 품목 요청을 취소했습니다',
    'a_user_requested' => '사용자가 웹사이트에서 품목을 요청했습니다',
    'acceptance_asset_accepted' => '사용자가 대상을 수락했습니다.',
    'acceptance_asset_declined' => '사용자가 대상을 거부하였습니다.',
    ...
    'asset_tag' => '자산 태그',
    'assets_warrantee_alert' => '다음 :threshold 일 내에 보증이 만료되는 :count 자산이 있습니다.|다음 :threshold 일 내에 보증이 만료되는 :count 자산이 있습니다.',
    'assigned_to' => '할당',
    'best_regards' => '감사합니다,',
    'canceled' => '취소됨',
    'checkin_date' => '반입 날짜',
    'checkout_date' => '반출 날짜',
    'checkedout_from' => '체크아웃함',
    'checkedin_from'  => '체크인함',
    'checked_into' => '체크인됨',
    ...
    'read_the_terms_and_click' => '아래 이용약관을 읽어보시고, 하단의 링크를 클릭하시하여 약관에 동의하시면 자산을 수령할 수 있습니다.',
    'requested' => '요청됨:',
    ...
    'type' => '유형',
    'upcoming-audits' => ':threshold 일 내에 감사 예정인 :count 자산이 있습니다.|:threshold 일 이내에 감사 예정인 :count 자산이 있습니다.',
    'user' => '사용자',
    'username' => '사용자명',
    'welcome' => '환영합니다 :name',
