...
return [
    ...
    'Accessory_Checkout_Notification' => '부속품 반출',
    'Asset_Checkin_Notification' => '자산 반입됨',
    'Asset_Checkout_Notification' => '자사 반출',
    ...
    'Consumable_checkout_notification' => '소모품 반출',
    'Days' => '일',
    'Expected_Checkin_Date' => '반출된 자산이 :date 에 반입될 예정입니다.',
    'Expected_Checkin_Notification' => '알림: :name 반입 마감일이 다가옴',
    ...
    'License_Checkout_Notification' => '라이센스 반출',
